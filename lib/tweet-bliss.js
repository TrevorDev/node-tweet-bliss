...
exports.createClient = function (consumer_key, consumer_secret, access_key, access_secret) {
    return new TwitterClient(consumer_key, consumer_secret, access_key, access_secret);
};